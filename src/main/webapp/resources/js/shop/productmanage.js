$(function () {
    var listUrl = '/schooloto/shopadmin/getproductlist?pageIndex=1&pageSize=999';
    var changeStatusURL = '/schooloto/shopadmin/changestatus';
    ...
    $('.product-wrap').on('click','a',function (e) {
        ...
        if (target.hasClss('edit')){
            window.location.href='/schooloto/shopadmin/productoperation?productId='+e.currentTarget.dataset.id;
        } else if (target.hasClass('status')){
            changeStatus(e.currentTarget.dataset.id,e.currentTarget.dataset.status);
        } else if (target.hasClass('preview')){
            window.location.href='/schooloto/frontend/productdetail?productId='+e.currentTarget.dataset.id;
        }
    });

    $('#new').click(function () {
        window.location.href='/schooloto/shopadmin/productoperation';
    });
})